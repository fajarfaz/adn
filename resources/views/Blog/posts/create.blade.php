					...
					<form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{route('posts.store')}}" method="POST" enctype="multipart/form-data">
						...
						<div class="mb-6">
						    ...
						    Title
					  		...
					  		<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="title" type="text" placeholder="title here" name="title" value="{{ old('title') }}">
					  		@if($errors->has('title'))
						...
						<div class="mb-6">
						    ...
						    Description
					  		...
					  		<textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="desc" name="desc" value="{{ old('desc') }}"></textarea>
					  		@if($errors->has('desc'))
						...
						<div class="mb-6">
						    ...
						    Keywords
					  		...
					  		<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="keywords" type="text" placeholder="W3, CSS, JS" name="keywords" value="{{ old('keywords') }}">
						...
						<div class="mb-6">
						    ...
						    Meta Desc
					  		...
					  		<input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="meta-desc" type="text" placeholder="Meta Description" name="meta_desc" value="{{ old('meta_desc') }}">
